...
export class IaConfiguracionService {
  ...
  async actualizar(dto: UpdateConfiguracionIaDto, actorId: string, ip: string | null): Promise<ConfiguracionIa> {
    ...
    await this.repo.update(actual.id, {
      ...
      ...(dto.ollamaHabilitado !== undefined ? { ollamaHabilitado: dto.ollamaHabilitado } : {}),
      ...(dto.ollamaUrl !== undefined ? { ollamaUrl: dto.ollamaUrl } : {}),
      ...(dto.ollamaPuerto !== undefined ? { ollamaPuerto: dto.ollamaPuerto } : {}),
      ...(dto.ollamaModelo !== undefined ? { ollamaModelo: dto.ollamaModelo } : {}),
      ...(dto.ollamaTimeoutMs !== undefined ? { ollamaTimeoutMs: dto.ollamaTimeoutMs } : {}),
      ...(dto.ollamaTemperatura !== undefined ? { ollamaTemperatura: dto.ollamaTemperatura } : {}),
      ...(dto.vozHabilitada !== undefined ? { vozHabilitada: dto.vozHabilitada } : {}),
      ...(dto.entradaVozHabilitada !== undefined ? { entradaVozHabilitada: dto.entradaVozHabilitada } : {}),
      ...(dto.respuestaVozHabilitada !== undefined ? { respuestaVozHabilitada: dto.respuestaVozHabilitada } : {}),
      ...(dto.vozVolumen !== undefined ? { vozVolumen: dto.vozVolumen } : {}),
      ...(dto.vozVelocidad !== undefined ? { vozVelocidad: dto.vozVelocidad } : {}),
      ...(dto.vozSeleccionada !== undefined ? { vozSeleccionada: dto.vozSeleccionada } : {}),
      ...(dto.vozIdioma !== undefined ? { vozIdioma: dto.vozIdioma } : {}),
      ...(dto.whisperUrl !== undefined ? { whisperUrl: dto.whisperUrl } : {}),
      ...(dto.whisperPuerto !== undefined ? { whisperPuerto: dto.whisperPuerto } : {}),
      ...(dto.whisperTimeoutMs !== undefined ? { whisperTimeoutMs: dto.whisperTimeoutMs } : {}),
      ...(dto.piperRutaBinario !== undefined ? { piperRutaBinario: dto.piperRutaBinario } : {}),
      ...(dto.piperRutaVoz !== undefined ? { piperRutaVoz: dto.piperRutaVoz } : {}),
      ...(dto.piperTimeoutMs !== undefined ? { piperTimeoutMs: dto.piperTimeoutMs } : {}),
