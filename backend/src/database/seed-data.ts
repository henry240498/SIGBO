...
export const PERMISOS: PermisoSeed[] = [
  ...
  { nombre: 'deposito:eliminar', recurso: 'deposito', accion: 'eliminar', categoria: 'Deposito' },
  { nombre: 'deposito:movimiento', recurso: 'deposito', accion: 'movimiento', categoria: 'Deposito' },
  { nombre: 'deposito:prestar', recurso: 'deposito', accion: 'prestar', categoria: 'Deposito' },
  { nombre: 'deposito:baja', recurso: 'deposito', accion: 'baja', categoria: 'Deposito' },
  { nombre: 'deposito:mantenimiento', recurso: 'deposito', accion: 'mantenimiento', categoria: 'Deposito' },
  { nombre: 'deposito:inventario_fisico', recurso: 'deposito', accion: 'inventario_fisico', categoria: 'Deposito' },
  { nombre: 'deposito:configurar', recurso: 'deposito', accion: 'configurar', categoria: 'Deposito' },
  // DOCUMENTOS
...
export const ROLES: RolSeed[] = [
  ...
  },
  {
    ...
    esAdministrativo: false,
    permisos: [
      'deposito:ver', 'deposito:crear', 'deposito:editar', 'deposito:eliminar', 'deposito:movimiento',
      'deposito:prestar', 'deposito:baja', 'deposito:mantenimiento', 'deposito:inventario_fisico', 'deposito:configurar',
      'organizacion:parametros_ver',
