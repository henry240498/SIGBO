...
terminos: [importacion, marcador, excel, marcacion, analizado, confirmado, cancelado, fila, duplicado, marcaciones, desde, digital, analiza, archivo, clasifica, reconocido, identificado, importado, inconsistente, antes, confirmar, analizar, escribe, asistencia]
---

# Importacion de marcaciones desde el marcador digital

Se analiza el archivo y se clasifica fila por fila (RECONOCIDO, NO_IDENTIFICADO, DUPLICADO, YA_IMPORTADO, INCONSISTENTE) antes de confirmar. Analizar no escribe asistencia.
...
- `affects` → [[entity--importacion-marcador|ImportacionMarcador]]
- `affects` → [[entity--importacion-marcador-fila|ImportacionMarcadorFila]]
