...
terminos: [pool, conexion, timeout, idle, colgada, mssql, reintento, 15s, conexiones, millis, bajo, reciclar, colgadas, usa, max, min, 15000, atascada, descarte, vez, reutilizarse, indefinidamente]
---

# Pool de conexiones con idleTimeoutMillis bajo para reciclar conexiones colgadas

El pool usa max 10, min 0 e idleTimeoutMillis 15000 para que una conexion atascada se descarte en vez de reutilizarse indefinidamente.
