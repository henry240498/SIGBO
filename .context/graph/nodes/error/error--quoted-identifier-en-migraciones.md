...
terminos: [quoted, identifier, migracion, sqlcmd, ansi, set, option, index, filtrado, migraciones, fallan, ejecutar, habilitado, hace, fallar, tablas, indices, filtrados, constraints, expresiones, runner, activa]
---

# Las migraciones fallan sin QUOTED_IDENTIFIER ON

Ejecutar las migraciones sin QUOTED_IDENTIFIER habilitado hace fallar las tablas con indices filtrados o constraints con expresiones. El runner ya lo activa.
