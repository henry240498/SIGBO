...
archivos:
  ...
  - frontend/src/lib/pantallas.generado.ts
  - frontend/src/lib/navegacion.ts
  - frontend/src/app/components/BuscadorPantallas.tsx
edges:
  - [affects, component--front-modulos]
terminos: [pantalla, ruta, navegacion, buscador, migas, breadcrumb, registro, generado, tabs, nueva, significa, regenerar, pantallas, lib, alimenta, pan, ctrl, genera, desde, arbol, rutas, cada, layout, regenera, existe, pero, nadie, encuentra]
---

# Pantalla nueva significa regenerar el registro de pantallas

src/lib/pantallas.generado.ts alimenta las migas de pan y el buscador Ctrl+K. Se genera desde el arbol de rutas y los TABS de cada layout; si no se regenera, la pantalla existe pero nadie la encuentra.
