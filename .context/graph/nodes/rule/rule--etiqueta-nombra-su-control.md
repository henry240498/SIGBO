...
severidad: MEDIA
archivos:
  - frontend/scripts/audit-accessibility.mjs
  - frontend/src/components/ComboBuscable.tsx
  - docs/GUIA-DE-ESTILO.md
edges:
  - [affects, component--front-modulos]
terminos: [label, htmlFor, aria-label, accesibilidad, formulario, campo, tabla, scope, th, useId, toda, etiqueta, nombra, control, todo, declara, cerrada, antes, decorativa, enfoca, hacer, clic, asocia, html, for, use, repite, lista, aria, texto, dinamico]
---

# Toda etiqueta nombra a su control, y todo th declara su scope

Una label cerrada antes del control es decorativa: no nombra el campo ni lo enfoca al hacer clic. Se asocia con htmlFor+id, con useId si el control se repite en una lista, o con aria-label si el texto es dinamico.
