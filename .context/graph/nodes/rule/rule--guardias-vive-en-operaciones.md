...
terminos: [guardias, operaciones, asistencia, esquema, schema, modulo, prefijo, nombre, dominio, propio, cuyas, tablas, viven, nest, tiene, permisos, pero, sus, siete, estan, uno, trampa, nombres, grande, proyecto]
---

# Guardias es un modulo propio cuyas tablas viven en el esquema operaciones

El modulo NestJS guardias tiene prefijo de permisos guardias, pero sus siete tablas estan en el esquema operaciones, no en uno propio. Es la trampa de nombres mas grande del proyecto.
...
- `affects` → [[component--modulo-guardias|guardias (modulo NestJS)]]
