...
<<<<<<< Updated upstream
terminos: [api, v1, prefijo, ruta, apifetch, swagger, puerto, 3001, 3000, cors, toda, vive, bajo, nunca, escribe, ese, set, global, prefix, fetch, incluye, origen, asi, pantallas, pasan, rutas, relativas, guardias, grupos]
=======
terminos: [api, v1, prefijo, ruta, apifetch, swagger, puerto, 3001, 3000, cors, toda, vive, bajo, nunca, escribe, ese, set, global, prefix, fetch, incluye, origen, asi, pantallas, pasan, rutas, relativas, organizacion, rangos]
>>>>>>> Stashed changes
---

# Toda la API vive bajo /api/v1 y el frontend nunca escribe ese prefijo

<<<<<<< Updated upstream
setGlobalPrefix('api/v1') en el backend. apiFetch ya incluye el origen y el prefijo, asi que las pantallas pasan rutas relativas como /guardias/grupos.
...
confuso.
=======
setGlobalPrefix('api/v1') en el backend. apiFetch ya incluye el origen y el prefijo, asi que las pantallas pasan rutas relativas como /organizacion/rangos.
