...
terminos: [tema, oscuro, claro, dark, light, token, apariencia, configuracion, contradiccion, esta, fijo, pantallas, aunque, prometa, temas, tienen, hex, oscuros, hardcodeados, hay, selector, registro, define, tokens, claros, auto, dos, cosas, conviven, integrarse]
---

# El tema oscuro esta fijo en las pantallas, aunque Configuracion prometa temas

Las pantallas tienen hex oscuros hardcodeados y no hay selector de tema. El registro de configuracion define tokens claros y tema auto. Las dos cosas conviven sin integrarse.
