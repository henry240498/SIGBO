...
terminos: [ip, gps, useragent, tecnico, privacidad, denuncia, permiso, anonimo, user, agent, exigen, aparte, denuncias, ver, alcanza, gestionar, pero, datos, tecnicos, denunciante, solo, devuelven]
---

# La IP, el GPS y el user agent de una denuncia exigen un permiso aparte

denuncias:ver alcanza para gestionar una denuncia, pero los datos tecnicos del denunciante solo se devuelven con denuncias:ver_datos_tecnicos.
...
- `affects` → [[api--denuncias-denuncias|DenunciasController]]
