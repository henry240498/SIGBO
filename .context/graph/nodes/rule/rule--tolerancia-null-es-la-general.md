...
terminos: [tolerancia, null, general, default, evento, minutos, entrada, salida, resolucion, tipo, regla, defecto, busca, activo, existe, aplica, fila, nunca, codifican, fijos]
---

# La tolerancia con tipoEventoId NULL es la regla general por defecto

Se busca la tolerancia ACTIVO del tipo de evento; si no existe, se aplica la fila ACTIVO con tipoEventoId NULL. Nunca se codifican minutos fijos en el backend.
...
- `affects` → [[table--operaciones-tolerancias-asistencia|operaciones.tolerancias_asistencia]]
- `belongs_to` → [[domain--asistencia|Asistencia]]

## Referenciado por

- [[decision--tolerancias-parametrizables|Las reglas de asistencia son datos parametrizables, no constantes de codigo]] `constrains` →
- [[workflow--asistencia-a-evento|Evento de asistencia, participantes y marcaciones]] `contains` →
