...
terminos: [modulo, menu, visible, prefijo, permiso, disponible, navegacion, slug, aparece, usuario, tiene, algun, compara, contra, permisos, ningun, empiece, invisible]
---

# Un modulo aparece en el menu si el usuario tiene algun permiso con su prefijo

moduloVisible() compara el permisoPrefijo del modulo contra los permisos del usuario. Un modulo sin ningun permiso que empiece con su prefijo es invisible.
