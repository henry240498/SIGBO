...
terminos: [entidad, tabla, columna, migracion, synchronize, typeorm, paralelo, invalid, column, cambiar, exige, correspondiente, mismo, cambio, false, agregar, crea, cambian, juntas, falla, tiempo, ejecucion]
---
...
- `affects` → [[configuration--conexion-datos|Conexion a SQL Server (TypeORM)]]
