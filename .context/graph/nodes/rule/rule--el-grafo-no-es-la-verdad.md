...
# Ante discrepancia entre el grafo y el codigo, gana el codigo

.context/ es un indice derivado. Sirve para encontrar y decidir que leer, nunca como evidencia de que algo funciona de cierta manera.
