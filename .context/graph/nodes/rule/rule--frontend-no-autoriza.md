...
terminos: [permiso, frontend, ocultar, boton, guard, autorizacion, seguridad, cosmetica, oculta, autoriza, chequeos, permisos, react, son, real, aplica, permissions, nunca, sustituye, endpoint]
---

# El frontend oculta, el backend autoriza

Los chequeos de permisos en React son cosmetica. La autorizacion real la aplica PermissionsGuard. Ocultar un boton nunca sustituye al permiso del endpoint.
