...
terminos: [migracion, inmutable, editar, numero, orden, esquema, ddl, prefijo, aplicada, nunca, edita, agrega, otra, archivos, database, migrations, son, inmutables, vez, ejecutados, todo, cambio, archivo, nuevo, siguiente, libre]
---

# Una migracion ya aplicada nunca se edita, se agrega otra

Los archivos de database/migrations son inmutables una vez ejecutados. Todo cambio de esquema es un archivo nuevo con el siguiente numero libre.
...
- `affects` → [[component--modulo-configuracion|configuracion (modulo NestJS)]]

## Referenciado por

- [[decision--migraciones-a-mano|Migraciones SQL escritas a mano con synchronize desactivado]] `constrains` →
