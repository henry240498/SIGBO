...
capa: frontend
permisos: [personal:editar, personal:eliminar_fisico, equipos:prestar, personal:seguros_ver, personal:seguros_crear, personal:seguros_editar, personal:seguros_eliminar, personal:generar_foja]
archivos:
...
terminos: [personal, editar, eliminar, fisico, equipos, prestar, seguros, ver, crear, generar, foja]
---
...
- **Ruta:** `/dashboard/personal/[id]`
- **Permisos referenciados:** `personal:editar`, `personal:eliminar_fisico`, `equipos:prestar`, `personal:seguros_ver`, `personal:seguros_crear`, `personal:seguros_editar`, `personal:seguros_eliminar`, `personal:generar_foja`
