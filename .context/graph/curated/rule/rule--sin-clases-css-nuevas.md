...
severidad: ALTA
archivos: [frontend/src/app/globals.css, frontend/scripts/audit-contraste.mjs, docs/GUIA-DE-ESTILO.md]
terminos: [css, clase, color, hex, inline, estilo, paleta, token, contraste, consistencia, tailwind, badge]
edges:
