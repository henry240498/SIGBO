...
dominio: seguridad
archivos: [backend/src/modules/configuracion/configuracion.registry.ts, backend/src/modules/configuracion/configuracion.service.ts]
terminos: [configuracion, registro, nivel, visitante, usuario, global, version, borrador, publicar, token]
edges:
