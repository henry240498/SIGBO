...
dominio: servicios
archivos: [backend/src/modules/servicios/servicios.controller.ts, backend/src/modules/servicios/servicios.service.ts, database/migrations/017_comunicaciones_servicio.sql]
terminos: [comunicacion, servicio, estado, borrador, revision, observado, finalizada, anulado, pdf]
edges:
