...
estado: VIGENTE
dominio: servicios
archivos: [database/migrations/017_comunicaciones_servicio.sql, backend/src/shared/entities/comunicacion-servicio.entity.ts]
terminos: [comunicacion, servicio, json, isjson, formulario, croquis, incendio, ocurrencias, documento]
edges:
