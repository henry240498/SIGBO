...
estado: VIGENTE
dominio: seguridad
archivos: [backend/src/modules/seguridad/policy-engine.service.ts, backend/src/modules/seguridad/guards/permissions.guard.ts]
terminos: [permisos, roles, policy, engine, autorizacion, rbac, directos, efectivos, guard]
edges:
