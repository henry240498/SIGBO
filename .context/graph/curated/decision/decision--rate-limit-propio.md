...
estado: VIGENTE
dominio: denuncias
archivos: [backend/src/modules/denuncias/guards/rate-limit.guard.ts, backend/src/modules/denuncias/decorators/rate-limit.decorator.ts]
terminos: [ratelimit, throttler, limite, abuso, spam, publico, ip, 429, ventana]
edges:
