...
estado: VIGENTE
archivos: [backend/src/core/database/data-source-options.ts, database/run-migrations.ps1]
terminos: [migracion, migraciones, synchronize, typeorm, esquema, ddl, orden]
edges:
