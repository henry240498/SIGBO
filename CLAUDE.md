...
Leer @.context/contexto.md y @.context/reglas.md antes de cambios. Consultar Vaults para trabajos importantes mediante .context/proyecto.json. Conservar las reglas específicas que siguen en este archivo.
<!-- END ECOSYSTEM ENTRY -->
