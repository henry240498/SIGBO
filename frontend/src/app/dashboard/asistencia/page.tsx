  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 16 }}>
        <Tarjeta titulo="En cuartel ahora" valor={indicadores.enCuartel} color="var(--success)" />
        <Tarjeta titulo="Eventos activos" valor={indicadores.eventosActivos} color="var(--signal)" />
        <Tarjeta
      ...
      <div className="card">
        ...
        {Object.keys(indicadores.participantesActivosPorTipoEvento).length === 0 ? (
          <p style={{ color: 'var(--muted)', fontSize: 13 }}>No hay eventos en curso en este momento.</p>
        ) : (
