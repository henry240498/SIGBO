    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      {mostrarForm && (
        <form className="card" onSubmit={guardar} style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          <div>
            <label style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>Requisitos</label>
            <textarea
              className="input-field"
              rows={4}
              value={requisitos}
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
          <thead>
            <tr style={{ textAlign: 'left', borderBottom: '1px solid #334155' }}>
              ...
              <th style={{ padding: '6px 4px' }}>Requisitos</th>
          ...
          <tbody>
            {especialidades.map((e) => (
              <tr key={e.id} style={{ borderBottom: '1px solid #1f2937' }}>
                ...
                <td style={{ padding: '6px 4px', color: '#94a3b8' }}>{truncar(e.requisitos)}</td>
                <td style={{ padding: '6px 4px' }}>
                  <span className="badge" style={{ background: e.estado === 'ACTIVO' ? '#166534' : '#7f1d1d' }}>
                    {e.estado}
                  </span>
                </td>
